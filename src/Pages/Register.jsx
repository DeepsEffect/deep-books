...
const Register = () => {
  ...
  const handleSignUp = (e) => {
    ...
    if (password.length < 6) {
      setSignUpError("password must be more than 6 characters");
    }
    if (!/^[\w-]+(\.[\w-]+)*@([\w-]+\.)+[a-zA-Z]{2,7}$/.test(email)) {
      setEmailError("Put a valid email");
    }
  ...
  return (
    <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800 mx-auto mt-6">
